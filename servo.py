# From https://github.com/redoxcode/micropython-servo/blob/main/src/servo/__init__.py
...
class Servo:
    def __init__(self, pin_id, min_us=544.0, max_us=2400.0, min_deg=0.0,
                 max_deg=180.0, freq=50):
